...
export type VInvoicesRecord<Tclient = unknown, Tinvoice_items = unknown, Tinvoice_payments = unknown, Tpaid = unknown, Tstore = unknown> = {
	client?: null | Tclient
	date: IsoDateString
	deleted?: IsoDateString
	discount?: number
...
export type ExpenseConceptsResponse<Texpand = unknown> = Required<ExpenseConceptsRecord> & BaseSystemFields<Texpand>
...
export type InvoicesItemsResponse<Texpand = unknown> = Required<InvoicesItemsRecord> & BaseSystemFields<Texpand>
export type InvoicesPaymentsResponse<Texpand = unknown> = Required<InvoicesPaymentsRecord> & BaseSystemFields<Texpand>
...
export type ProductsStoresResponse<Texpand = unknown> = Required<ProductsStoresRecord> & BaseSystemFields<Texpand>
...
export type VInvoicesResponse<Tclient = unknown, Tinvoice_items = unknown, Tinvoice_payments = unknown, Tpaid = unknown, Tstore = unknown, Texpand = unknown> = Required<VInvoicesRecord<Tclient, Tinvoice_items, Tinvoice_payments, Tpaid, Tstore>> & BaseSystemFields<Texpand>
...
export type TypedPocketBase = PocketBase & {
	...
	collection(idOrName: 'expenseConcepts'): RecordService<ExpenseConceptsResponse>
	...
	collection(idOrName: 'invoices_payments'): RecordService<InvoicesPaymentsResponse>
	...
	collection(idOrName: 'products_stores'): RecordService<ProductsStoresResponse>
